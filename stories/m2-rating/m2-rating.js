customElements.define(
  ...
  class extends HTMLElement {
      ...
      return `
        <style>
            ...
            meter {
                ...
                <text font-size="100" fill="${this.color.replace(
                  '#',
                  '%23'
                )}" y=".8em" opacity="0.3">★</text>\
    ...
    #handleClick = (e) => {
      this.dispatchEvent(
        new CustomEvent('onRatingclick', {
          bubbles: true,
          composed: true,
          detail: {
            width: e.currentTarget.offsetWidth,
            position: e.offsetX,
            ratingNumber: Math.ceil(
              e.offsetX / (e.currentTarget.offsetWidth / this.max)
            ),
          },
        })
      );
